...
export function CorporateHero() {
  return <section id="accueil" className="relative isolate overflow-hidden bg-[#0f2e36] py-24 text-white sm:py-32 lg:min-h-[700px] lg:py-44">
    ...
    <Container><div className="max-w-3xl">
      ...
      <p className="mt-7 max-w-2xl animate-fade-in-up text-lg leading-8 text-white/80 [animation-delay:300ms]">J&amp;B SANIYAPUR SARL accompagne les organisations avec des solutions de maintenance immobilière, de nettoyage industriel, de bionettoyage et d’hygiène professionnelle.</p>
      <div className="mt-10 flex animate-fade-in-up flex-col gap-3 sm:flex-row [animation-delay:400ms]"><ButtonLink href="#services">Découvrir nos services</ButtonLink><ButtonLink href="#contact" variant="secondary" className="border-white/45 text-white hover:border-white hover:bg-white hover:text-[#16232a]">Demander un devis</ButtonLink></div>
    </div></Container>
  </section>;
}
